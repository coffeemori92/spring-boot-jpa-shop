...
import jpabook.jpashop.exceptions.NotEnoughStockException;
...
public class OrderServiceTest {
	...
	public void 상품주문() throws Exception {
		...
		assertEquals("주문한 상품 종류 수가 정확해야 한다.", 1, getOrder.getOrderedItems().size());
	...
	public void 상품주문_재고수량초과() throws Exception {
		Member member = createMember();
		Item item = createBook("회원1",10000, 10);
